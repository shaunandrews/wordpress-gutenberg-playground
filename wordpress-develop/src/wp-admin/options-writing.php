...
<h2 class="title"><?php _e( 'Writing Guidance' ); ?></h2>

<p><label for="wp_writing_guidance_expectations"><strong><?php _e( 'Expectations' ); ?></strong><br />
<?php _e( 'Describe how content on this site should be written. These expectations help authors stay consistent and aligned.' ); ?></label></p>

<textarea name="wp_writing_guidance_expectations" id="wp_writing_guidance_expectations" class="large-text code" rows="4"><?php echo esc_textarea( get_option( 'wp_writing_guidance_expectations' ) ); ?></textarea>

<p><label for="wp_writing_guidance_goals"><strong><?php _e( 'Goals' ); ?></strong><br />
<?php _e( 'Describe what you want your content to achieve. These goals help authors focus on outcomes like subscriptions, engagement, or product discovery.' ); ?></label></p>

<textarea name="wp_writing_guidance_goals" id="wp_writing_guidance_goals" class="large-text code" rows="4"><?php echo esc_textarea( get_option( 'wp_writing_guidance_goals' ) ); ?></textarea>

<?php do_settings_fields( 'writing', 'writing_guidance' ); ?>
